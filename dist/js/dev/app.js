...
function initHeaderHeight() {
  ...
  ro.observe(header);
  const onResize2 = () => requestAnimationFrame(setVar);
  window.addEventListener("resize", onResize2, { passive: true, signal });
}
(() => {
...
function initSliders() {
  ...
  if (document.querySelector(".widget-products__slider")) {
    new Swiper(".widget-products__slider", {
      ...
      loop: true,
      pagination: {
        el: ".widget-products__slider .swiper-pagination",
        clickable: true
      },
      navigation: {
        prevEl: ".widget-products .swiper-button--prev",
        nextEl: ".widget-products .swiper-button--next"
      },
      breakpoints: {
        575: {
          slidesPerView: 3,
  ...
  const thumb = document.querySelector(".product-gallery__thumbs");
  if (thumb) {
    let initialSlide = 0;
    const productThumbsSwiper = new Swiper(thumb, {
      modules: [Navigation, Thumb, Mousewheel, freeMode],
      initialSlide,
      observer: true,
      observeParents: true,
      slidesPerView: 5.2,
    ...
    new Swiper(".product-gallery__main", {
      ...
      pagination: {
        el: ".product-gallery__main .swiper-pagination",
        clickable: true
      },
      thumbs: {
